...
void value_update_str( Value *value )
{
    switch ( value->type ) {
		...
		case SDLK_YELLOW: strcpy( value->val_str, _("Yellow") ); break;
		case SDLK_BLUE: strcpy( value->val_str, _("Blue") ); break;
		case SDLK_HELP: strcpy( value->val_str, _("Help") ); break;
		case SDLK_MENU: strcpy( value->val_str, _("Menu") ); break;
		case SDLK_TV: strcpy( value->val_str, _("Tv") ); break;
		case SDLK_EPG: strcpy( value->val_str, _("Epg") ); break;
		case SDLK_POWER: strcpy( value->val_str, _("Power") ); break;
		case SDLK_VOLUP: strcpy( value->val_str, _("Volume up") ); break;
		case SDLK_VOLDOWN: strcpy( value->val_str, _("Volume down") ); break;
		case SDLK_INFO: strcpy( value->val_str, _("Info") ); break;
		case SDLK_FAV: strcpy( value->val_str, _("Favorites") ); break;
		case SDLK_TEXT: strcpy( value->val_str, _("Text") ); break;
		case SDLK_PAGEUP: strcpy( value->val_str, _("Page up") ); break;
		case SDLK_PAGEDOWN: strcpy( value->val_str, _("Page down") ); break;
		case SDLK_MODE: strcpy( value->val_str, _("Mode") ); break;
		case SDLK_PLAY: strcpy( value->val_str, _("Play") ); break;
		case SDLK_PAUSE: strcpy( value->val_str, _("Pause") ); break;
                default:
